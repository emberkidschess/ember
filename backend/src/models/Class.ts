...
export interface IClass extends Document {
  ...
  // "demo" is a legacy persisted value; the business workflow is trial.
...
const ClassSchema: Schema = new Schema(
  {
    ...
    classType: {
      type: String,
      // Keep demo readable for legacy documents while all new API writes
      // validate to trial (see createClassSchema).
